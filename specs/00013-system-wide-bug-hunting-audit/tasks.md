...
- [X] T414 [OBJ-72] {(OR-336)} Reconcile QC, Brain and marker digests and create `.qc-passed` only after every gate is PASS under the feature workspace [Z-DOCS/QC]
- [X] T415 [OBJ-72] {(FR-351)} {(TR-354)} Publish through PR and required checks, verify protected main/release SHA and store remote receipts under `specs/00013-system-wide-bug-hunting-audit/evidence/` [Git/Remote]
