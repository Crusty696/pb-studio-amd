...
- [ ] T009 [P] Binding-Wächter auf exakte Pfade und passende DataContexts umstellen; Tests/test_viewmodel_binding_wiring.py
- [ ] T010 DTOs mit generierten NSwag-Typen konsolidieren; PBStudio.UI/
- [ ] T011 Brain-Semantik/Projector mit realen Medien und 20 korrekt bezeichneten Bewertungen prüfen; evidence/
- [ ] T012 Render-Retention und progress_percent schließen; backend/routers/render_router.py
- [ ] T013 Externes Config-Hot-Reload schließen; src/pb_studio/core/config.py
- [ ] T014 Echte Chat-Token-Deltas verdrahten; src/pb_studio/ai/chat_agent.py
- [ ] T015 Video-Grid-Virtualisierung nach explizitem Detaildesign implementieren; PBStudio.UI/Views/VideoLibraryView.xaml
...
- [ ] T017 Test-Skip-Ausnahmen aktuell prüfen und begründet behandeln; config/pytest-skip-allowlist.json
- [ ] T018 Security-Ausnahmen aktuell prüfen und begründet behandeln; config/
- [ ] T019 Alte Wegwerf-Umgebungen auf Nutzung prüfen und kontrolliert bereinigen; .venv-pre-lock-20260830 und .venv-lock
