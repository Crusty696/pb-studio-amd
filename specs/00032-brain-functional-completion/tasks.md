# Tasks: Brain/HIRN Functional Completion

- [X] T001 [US3] {FR-413,FR-414} Catalog every productive HIRN control and state transition in `test-report/function-catalog.md`.
- [X] T002 [US1] {FR-408} Audit and repair bridge feature normalization, axis availability, cold-start priors, scorer denominator, and contribution reporting.
- [X] T003 [US2] {FR-409,FR-410} Audit and repair sparse feedback credit, context backoff, replay/recovery, cut ownership, and project leases.
- [X] T004 [US1] {FR-411,TR-381} Audit and repair semantic embedding validation, projector load/training state, dimension contracts, and explicit degradation.
