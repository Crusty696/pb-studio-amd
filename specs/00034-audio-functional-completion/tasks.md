# Tasks: Audio Functional Completion

- [X] T001 [US1] {FR-422,FR-428} Catalog every productive Audio Library control and state transition in `test-report/function-catalog.md`.
- [X] T002 [US1] {FR-422,FR-425} Audit and repair import, list, metadata, hash, waveform, duplicate, delete, persistence, and project leases.
- [X] T003 [US2] {FR-423,FR-427} Audit and repair short-file BPM, beat/downbeat, key, energy, structure, spectral, onset/drum-trigger, and partial-result truth.
- [X] T004 [US2] {FR-424,FR-425} Audit and repair long-file streaming threshold, chunk evidence, overlap deduplication, cancellation, persistence, and resume.
